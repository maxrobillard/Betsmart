...
def Navbar():
    ...
    items=[
        dbc.Row([dbc.DropdownMenuItem("Kaczmarczyk Victor",href="https://www.linkedin.com/in/victor-kaczmarczyk-747a85196/",external_link=True)],style={"margin-left":"5px"}),
        dbc.Row([dbc.DropdownMenuItem("Robillard Maxime",href="https://www.linkedin.com/in/maxime-robillard/",external_link=True)],style={"margin-left":"5px"}),
        ]
    navbar = dbc.Nav(
                    [
                        dbc.Row([
